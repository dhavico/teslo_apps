...
final productProvider = StateNotifierProvider.autoDispose
  ...
  return ProductNotifier(
      produtcsRepository: produtcsRepository, productId: productId);
});

class ProductNotifier extends StateNotifier<ProductState> {
  final ProdutcsRepository produtcsRepository;
  ProductNotifier({required this.produtcsRepository, required String productId})
  ...
  Future<void> loadProduct() async {
    try {
      ...
      final product = await produtcsRepository.getProductById(state.id);
